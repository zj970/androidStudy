...
import com.example.recyclerviewdemo.databinding.ItemGroupRvBinding;
...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        viewHolder.binding.group.setOnClickListener(v -> {
            ...
            //修改图标
            viewHolder.binding.ivFlag.setImageDrawable(ContextCompat.getDrawable(parent.getContext(),isShow ? R.drawable.ic_right:R.drawable.ic_down));
            //显示或隐藏联系人列表
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ItemGroupRvBinding binding;
        public ViewHolder(@NonNull @NotNull ItemGroupRvBinding itemGroupRvBinding) {
